      ...
      <div class = "main">
            ...
            <P>Create your free account now with a storage capacity of up to 500MB.
                This space can be used to store documents, photos, videos and any other type of file,
                 which can be accessed from any device connected to the internet.</P>
                 </div>
                 <button type="submit" name="Upload" id="Upload"> Upload<script src="https://cdn.lordicon.com/ritcuqlt.js"></script>
<lord-icon
